...
<section id="treatment-hero" class="hero">
	<div class="row">
		<div class="medium-10 medium-centered columns content text-center">
			<h1>Lorem ipsum Treatment</h1>
...
<section class="row content">
	<div class="large-8 columns">
		<h2 class="text-center below-3">What we Treat</h2>
...
<section class="light-grey-bx">
	<div class="row content">
		<div class="small-12 medium-10 medium-centered large-8 columns text-center">
			<h4>Accrediations & Memberships</h4>
			<img src="<?php echo get_template_directory_uri(); ?>/style/images/accreditations-grey.jpg" alt="Accreditation Logos">
		</div>
	</div>
</section>
